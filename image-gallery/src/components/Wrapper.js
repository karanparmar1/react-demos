...
class Wrapper extends React.Component {
    ...
    getData = (query = '') => {
        ...
        if (this.isBlank(query)) {
            url = 'https://api.unsplash.com/photos/?client_id=HgyIReDaPCDFba86F_F4E8ELnbcg8s3PdxWnHq292ZM&per_page=16'; //Default URL for random Images//AuthKey//BGtUVlndC8IQAjSFGDKUMPBTCNNO9fvRaczJH3KuUms
        }
        else {
            url = 'https://api.unsplash.com/search/photos/?client_id=HgyIReDaPCDFba86F_F4E8ELnbcg8s3PdxWnHq292ZMper_page=16&query=' + query;
        }
