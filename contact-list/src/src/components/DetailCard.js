...
const DetailCard = ({ id, open }) => {
    ...
    return (
        id ? <Grid container item xs={12} spacing={3}  justify="center" className="bg-silver" style={{ margin: "8px 16px", padding: "16px 32px", textAlign: "left" }}>
            ...
            <Grid container item  justify="center">
                ...
                <Grid item  className="text-black">Karan Parmar</Grid>
            </Grid>
            <Grid container item>
